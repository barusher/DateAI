...
public class TinderBoltApp extends MultiSessionTelegramBot {
    public static final String TELEGRAM_BOT_NAME = "TinderDateAI_bot"; //TODO: добавь имя бота в кавычках
    public static final String TELEGRAM_BOT_TOKEN = "7239863284:AAHiEqTovSxspnoGwQlOlYw-OYPveBiiNAE"; //TODO: добавь токен бота в кавычках
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if(currentMode == DialogMode.DATE && !isMessageCommand()){
            ...
            Message msg = sendTextMessage("Подождите пару секунд - звезда набиарет текст...");
        ...
        if(currentMode == DialogMode.PROFILE && !isMessageCommand()){
            switch (questionCount){
                ...
                case 2:
                    ...
                    questionCount = 3;
                    sendTextMessage("Есть ли у вас какое-то хобби?");
                    return;
                case 3:
                    me.hobby = message;
                    questionCount = 4;
        ...
        sendTextMessage("В данный момент такой команды нет, извините!");
        sendPhotoMessage("sad");
